...
uses Windows, ActiveX, Classes, Graphics, OleServer, OleCtrls, StdVCL, Messages;
...
// *********************************************************************//
  ...
  private
    ...
    function GetIDispatchProp(const Index: Integer): IDispatch;
    function GetIntegerProp(const Index: Integer): Integer;
    function GetTOleEnumProp(const Index: Integer): TOleEnum;
    ...
    procedure SetWideStringProp(const Index: Integer;
...
function TWebBrowser.GetIDispatchProp(const Index: Integer): IDispatch;
begin
  result := inherited GetIDispatchProp(Index);
end;

function TWebBrowser.GetIntegerProp(const Index: Integer): Integer;
begin
  result := inherited GetIntegerProp(Index);
end;

function TWebBrowser.GetTOleEnumProp(const Index: Integer): TOleEnum;
begin
  result := inherited GetTOleEnumProp(Index);
end;

function TWebBrowser.GetWideStringProp(const Index: Integer): WideString;
begin
  result := inherited GetWideStringProp(Index);
end;

function TWebBrowser.GetWordBoolProp(const Index: Integer): WordBool;
begin
  result := inherited GetWordBoolProp(Index);
end;

procedure TWebBrowser.SetIntegerProp(const Index, Value: Integer);
begin
  inherited SetIntegerProp(Index,Value);
end;

procedure TWebBrowser.SetWideStringProp(const Index: Integer;
  const Value: WideString);
begin
  inherited SetWideStringProp(Index,Value);
end;

procedure TWebBrowser.SetWordBoolProp(const Index: Integer;
  const Value: WordBool);
begin
  inherited SetWordBoolProp(Index,Value);
end;

procedure TWebBrowser.WndProc(var Message: TMessage);
begin
