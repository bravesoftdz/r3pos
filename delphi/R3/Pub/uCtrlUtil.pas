...
begin
  ...
  case SortMarket of
    ...
    smDownEh:begin
        TZAbstractRODataset(DataSet).SortedFields := Column.FieldName;
        TZAbstractRODataset(DataSet).SortType := stDescending;
      end;
    smUpEh:begin
        TZAbstractRODataset(DataSet).SortedFields := Column.FieldName;
        TZAbstractRODataset(DataSet).SortType := stAscending;
      end;
  end;
end;
