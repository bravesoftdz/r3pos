...
begin
  ...
  N26Version:=ReadBool('rim','USING_CUST_PSWD',false);
...
procedure TWsdlSyncFactory.SetN26Version(const Value: boolean);
begin
  FN26Version := Value;
end;
