...
const
  ...
  RF_DATA_SOURCE4=
     ...
     'CURR_SALE_PRF_RATE=毛利率,YEAR_SALE_PRF_RATE=毛利率(同期),PRIOR_SALE_PRF_RATE=毛利率(上期),YEAR_SALE_PRF_DIFF_RATE=毛利率(同期差),PRIOR_SALE_PRF_DIFF_RATE=毛利率(上期差),HINT_DAYS_AMT=库存建议,NEW_INPRICE=最新进价,NEW_OUTPRICE=最新售价';
  //2012.01.12 Add数据源 
  RF_DATA_SOURCE5=
