...
procedure TfrmAllRckReport.fndP1_SORT_IDKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  sid1 := '';
...
procedure TfrmAllRckReport.fndP1_SORT_IDPropertiesButtonClick(
...
function TfrmAllRckReport.CheckRowColor: boolean;
var
  i:Integer;
begin
  LCK_Index := -1;
