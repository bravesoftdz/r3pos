...
begin
  result :=
   ...
   'select A.*,B.AMOUNT,B.CALC_AMOUNT,B.COST_PRICE,B.APRICE,B.CALC_MONEY,B.SEQNO,B.PROPERTY_01,B.PROPERTY_02,B.UNIT_ID,B.BATCH_NO,B.GODS_ID,B.IS_PRESENT from STO_CHANGEORDER A,STO_CHANGEDATA B '+
