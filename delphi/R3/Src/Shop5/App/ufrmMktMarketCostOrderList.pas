unit ufrmMktMarketCostOrderList;
...
type
  TfrmMktMarketCostOrderList = class(TframeContractToolForm)
    RzLabel2: TRzLabel;
    RzLabel3: TRzLabel;
    RzLabel4: TRzLabel;
    RzLabel5: TRzLabel;
...
procedure TfrmMktMarketCostOrderList.actNewExecute(Sender: TObject);
begin
...
procedure TfrmMktMarketCostOrderList.actDeleteExecute(Sender: TObject);
begin
...
procedure TfrmMktMarketCostOrderList.actEditExecute(Sender: TObject);
begin
...
procedure TfrmMktMarketCostOrderList.actSaveExecute(Sender: TObject);
begin
  inherited;
  if (CurContract<>nil) then
     begin
...
procedure TfrmMktMarketCostOrderList.actPrintExecute(Sender: TObject);
begin
  inherited;
...
procedure TfrmMktMarketCostOrderList.actPreviewExecute(Sender: TObject);
begin
  inherited;
  if not ShopGlobal.GetChkRight('100002150',6) then Raise Exception.Create('你没有打印订货单的权限,请和管理员联系.');
  with TfrmFastReport.Create(Self) do
...
procedure TfrmMktMarketCostOrderList.Open(Id: string);
var
  rs:TZQuery;
  sm:TMemoryStream;
begin
...
procedure TfrmMktMarketCostOrderList.actInfoExecute(Sender: TObject);
begin
  inherited;
  if (CurContract=nil) then
     begin
...
procedure TfrmMktMarketCostOrderList.actAuditExecute(Sender: TObject);
begin
...
procedure TfrmMktMarketCostOrderList.actPriorExecute(Sender: TObject);
var
  Temp:TZQuery;
  Params:TftParamList;
begin
...
procedure TfrmMktMarketCostOrderList.actNextExecute(Sender: TObject);
var
  Temp:TZQuery;
  Params:TftParamList;
begin
...
procedure TfrmMktMarketCostOrderList.frfMktPlanOrderListGetValue(
...
function TfrmMktMarketCostOrderList.EncodeSQL(id: string): string;
var w,w1:string;
begin
...
function TfrmMktMarketCostOrderList.CheckCanExport: boolean;
begin
  result:=ShopGlobal.GetChkRight('100002150',7);
end;

procedure TfrmMktMarketCostOrderList.DBGridEh1DblClick(Sender: TObject);
begin
  inherited;
  actInfo.OnExecute(nil)
end;

procedure TfrmMktMarketCostOrderList.cdsListAfterScroll(DataSet: TDataSet);
begin
  inherited;
...
procedure TfrmMktMarketCostOrderList.FormShow(Sender: TObject);
begin
  inherited;
  Open('');
  //进入窗体默认新增加判断是否新增权限:
...
procedure TfrmMktMarketCostOrderList.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmMktMarketCostOrderList.DBGridEh1DrawColumnCell(Sender: TObject;
...
procedure TfrmMktMarketCostOrderList.K2PropertiesValidate(Sender: TObject;
...
procedure TfrmMktMarketCostOrderList.K1PropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
