...
begin
  ...
  ' left join VIW_USERS C on A.TENANT_ID=C.TENANT_ID and A.PRICING_USER=C.USER_ID where A.TENANT_ID=:TENANT_ID and A.SHOP_ID=:SHOP_ID and A.GODS_ID=:GODS_ID order by ROWS_ID';
end;
