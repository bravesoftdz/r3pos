...
//  fndCLIENT_ID.DataSet := Global.GetZQueryFromName('PUB_CUSTOMER');
  ...
  fndPAYM_ID.ItemIndex := TdsItems.FindItems(fndPAYM_ID.Properties.Items,'CODE_ID',ShopGlobal.LoadFormatIni('ufrmRecvPosListData_cache','PAYM_ID'));
  InitGrid;
  //第一分页应收账款:
...
procedure TfrmRecvPosList.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  inherited;
  if fndPAYM_ID.ItemIndex<>-1 then //2011.09.22加判断
  begin
