...
begin
  ...
  if not frmMain.FindAction('actfrmMktAtthOrderList').Enabled then Raise Exception.Create('找不到"费用申领"模块,请和管理员联系.');;
  frmMain.FindAction('actfrmMktAtthOrderList').OnExecute(nil);
