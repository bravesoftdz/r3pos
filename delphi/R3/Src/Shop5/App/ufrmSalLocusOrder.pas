...
begin
  ...
  Factor.UpdateBatch(cdsLocusNo,'TSalesForLocusNo');
  dbState := dsBrowse;
end;
...
function TfrmSalLocusOrder.GodsToLocusNo(id: string): boolean;
var
  rs,bs:TZQuery;
  AObj:TRecord_;
  r:boolean;
...
function TfrmSalLocusOrder.NextLocusNo:boolean;
var
  bs:TZQuery;
begin
  result := false;
