...
begin
  ...
  try
    ...
    Factor.UpdateBatch(cdsLocusNo,'TSalRetuForLocusNo',Params);
  finally
    Params.free;
  end;
  dbState := dsBrowse;
...
procedure TfrmSalRetuLocusOrder.DBGridEh1CellClick(Column: TColumnEh);
begin
//  inherited;
...
procedure TfrmSalRetuLocusOrder.DBGridEh1Columns6EditButtonClick(
