...
procedure TfrmSalRetuOrder.GridToGods(Grid, id: string);
begin
  inherited;
end;

procedure TfrmSalRetuOrder.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = '+' then
     begin
...
procedure TfrmSalRetuOrder.N3Click(Sender: TObject);
//var frmSalRetuOrderList:TfrmSalRetuOrderList;
//  i:integer;
//  r:boolean;
begin
