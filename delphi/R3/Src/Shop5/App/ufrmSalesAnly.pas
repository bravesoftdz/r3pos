...
type
  TfrmSalesAnly = class(TframeToolForm)
    RzPanel1: TRzPanel;
    Splitter1: TSplitter;
    CdsStorage: TZQuery;
    RzPanel7: TRzPanel;
...
function TfrmSalesAnly.FindColumn(DBGrid: TDBGridEh;
...
procedure TfrmSalesAnly.InitGrid;
var rs:TZQuery;
    Column:TColumnEh;
begin
...
procedure TfrmSalesAnly.LoadTree;
var rs:TZQuery;
    i,j:Integer;
    Aobj:TRecord_;
begin
...
procedure TfrmSalesAnly.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmSalesAnly.FormDestroy(Sender: TObject);
begin
  inherited;
  TDbGridEhSort.FreeForm(Self);
end;

function TfrmSalesAnly.EncodeSql(ID: String): String;
...
procedure TfrmSalesAnly.Open(ID: String);
var rs:TZQuery;
    rm:TMemoryStream;
begin
...
procedure TfrmSalesAnly.FormKeyDown(Sender: TObject;
...
procedure TfrmSalesAnly.edtSHOP_TYPEPropertiesChange(
  Sender: TObject);
begin
  inherited;
  Shop_Type_Change;
...
procedure TfrmSalesAnly.Shop_Type_Change;
begin
...
procedure TfrmSalesAnly.AddGoodTypeItems(
...
procedure TfrmSalesAnly.AddGoodsIDItems;
...
procedure TfrmSalesAnly.rzTreeChange(Sender: TObject;
  Node: TTreeNode);
begin
  inherited;
  Open('');
...
procedure TfrmSalesAnly.edtGoods_TypePropertiesChange(
  Sender: TObject);
begin
  inherited;
  AddGoodsIDItems;
...
function TfrmSalesAnly.TransUnit(CalcIdx: Integer;
...
procedure TfrmSalesAnly.actFindExecute(Sender: TObject);
begin
  inherited;
  Open('');
end;

procedure TfrmSalesAnly.GridDrawColumnCell(Sender: TObject;
...
procedure TfrmSalesAnly.GridGetCellParams(Sender: TObject;
...
procedure TfrmSalesAnly.CdsStorageAfterScroll(DataSet: TDataSet);
begin
  inherited;
  GetNo;
end;

procedure TfrmSalesAnly.GetNo;
var Str:String;
begin
...
function TfrmSalesAnly.TransPrice(CalcIdx: Integer;
...
function TfrmSalesAnly.TransCalcRate(CalcIdx: Integer; AliasTabName,
...
procedure TfrmSalesAnly.actPreviewExecute(Sender: TObject);
begin
  inherited;
...
procedure TfrmSalesAnly.actPrintExecute(Sender: TObject);
begin
  inherited;
  if Grid = nil then Exit;
  PrintView;
...
procedure TfrmSalesAnly.PrintView;
...
function TfrmSalesAnly.FormatString(TextStr: String;
