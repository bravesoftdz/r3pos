...
begin
  ...
  begin
    strSql :=
      'select '+
      ' TENANT_ID,GODS_ID,SHOP_ID,SHOP_NAME as SHOP_ID_TEXT,isnull(REGION_ID,''#'') as SREGION_ID,CALC_BARCODE,GODS_CODE,GODS_NAME as GODS_ID_TEXT,''#'' as PROPERTY_01,''#'' as BATCH_NO,''#'' as PROPERTY_02,UNIT_ID  '+
      ...
      ' from '+
       '(SELECT '+
       ' A.TENANT_ID,A.GODS_ID,A.SHOP_ID,B.SHOP_NAME,B.REGION_ID,c.BARCODE as CALC_BARCODE,c.GODS_CODE,c.GODS_NAME,'+
      ...
      ' group by TENANT_ID,SHOP_ID,SHOP_NAME,REGION_ID,GODS_ID,CALC_BARCODE,GODS_CODE,GODS_NAME,UNIT_ID '+
  ...
  begin
    ...
    strSql :=
      'SELECT '+
      ' A.TENANT_ID '+
      ',A.GODS_ID,B.SHOP_ID,B.SHOP_NAME as SHOP_ID_TEXT,isnull(B.REGION_ID,''#'') as SREGION_ID '+
      ...
      'group by A.TENANT_ID,A.GODS_ID,B.SHOP_ID,B.SHOP_NAME,B.REGION_ID,c.BARCODE,c.GODS_CODE,c.GODS_NAME,'+GetUnitID(fndP1_UNIT_ID.ItemIndex,'C')+' '+
      ',C.RELATION_ID,C.SORT_ID1,C.SORT_ID2,C.SORT_ID3,C.SORT_ID4,C.SORT_ID5,C.SORT_ID6,C.SORT_ID7,C.SORT_ID8,C.SORT_ID9,C.SORT_ID10 '+
      ',C.SORT_ID11,C.SORT_ID12,C.SORT_ID13,C.SORT_ID14,C.SORT_ID15,C.SORT_ID16,C.SORT_ID17,C.SORT_ID18,C.SORT_ID19,C.SORT_ID20 ';
