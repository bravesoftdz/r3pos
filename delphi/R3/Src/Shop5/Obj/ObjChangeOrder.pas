...
begin
  ...
  SelectSQL.Text :=
               ...
               ' select CHANGE_ID,TENANT_ID,SHOP_ID,GLIDE_NO,CHANGE_DATE,DEPT_ID,CHANGE_TYPE,CHANGE_CODE,DUTY_USER,REMARK,CHK_USER,CHK_DATE,FROM_ID,CREA_DATE,CHANGE_AMT,CHANGE_MNY,CREA_USER,COMM,'+
  ...
  IsSQLUpdate := True;
  Str := 'insert into STO_CHANGEORDER(CHANGE_ID,TENANT_ID,SHOP_ID,GLIDE_NO,CHANGE_DATE,CHANGE_TYPE,CHANGE_CODE,DUTY_USER,REMARK,CHK_USER,CHK_DATE,FROM_ID,CHANGE_AMT,CHANGE_MNY,CREA_DATE,CREA_USER,DEPT_ID,COMM,TIME_STAMP) '
    + 'VALUES(:CHANGE_ID,:TENANT_ID,:SHOP_ID,:GLIDE_NO,:CHANGE_DATE,:CHANGE_TYPE,:CHANGE_CODE,:DUTY_USER,:REMARK,:CHK_USER,:CHK_DATE,:FROM_ID,:CHANGE_AMT,:CHANGE_MNY,:CREA_DATE,:CREA_USER,:DEPT_ID,''00'','+GetTimeStamp(iDbType)+')';
  InsertSQL.Text := Str;
