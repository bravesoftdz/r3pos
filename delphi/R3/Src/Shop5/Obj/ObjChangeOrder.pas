...
begin
  ...
  IsSQLUpdate := True;
  Str := 'insert into STO_CHANGEORDER(CHANGE_ID,TENANT_ID,SHOP_ID,GLIDE_NO,CHANGE_DATE,CHANGE_TYPE,LINKMAN,TELEPHONE,SEND_ADDR,CHANGE_CODE,DUTY_USER,REMARK,CHK_USER,CHK_DATE,FROM_ID,CHANGE_AMT,CHANGE_MNY,CREA_DATE,CREA_USER,DEPT_ID,COMM,TIME_STAMP) '
    + 'VALUES(:CHANGE_ID,:TENANT_ID,:SHOP_ID,:GLIDE_NO,:CHANGE_DATE,:CHANGE_TYPE,:LINKMAN,:TELEPHONE,:SEND_ADDR,:CHANGE_CODE,:DUTY_USER,:REMARK,:CHK_USER,:CHK_DATE,:FROM_ID,:CHANGE_AMT,:CHANGE_MNY,:CREA_DATE,:CREA_USER,:DEPT_ID,''00'','+GetTimeStamp(iDbType)+')';
  InsertSQL.Text := Str;
  Str := 'update STO_CHANGEORDER set CHANGE_ID=:CHANGE_ID,TENANT_ID=:TENANT_ID,SHOP_ID=:SHOP_ID,GLIDE_NO=:GLIDE_NO,CHANGE_DATE=:CHANGE_DATE,CHANGE_TYPE=:CHANGE_TYPE,LINKMAN=:LINKMAN,TELEPHONE=:TELEPHONE,'+
      'SEND_ADDR=:SEND_ADDR,CHANGE_CODE=:CHANGE_CODE,DUTY_USER=:DUTY_USER,REMARK=:REMARK,'+
