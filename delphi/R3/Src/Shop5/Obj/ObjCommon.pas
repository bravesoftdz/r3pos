...
begin
  ...
  4:result := '(coalesce(JULIAN_DAY(substr(trim(char('+E+')),1,4)||''-''||substr(trim(char('+E+')),5,2)||''-''||substr(trim(char('+E+')),7,2) ) - JULIAN_DAY( substr(trim(char('+B+')),1,4)||''-''||substr(trim(char('+B+')),5,2)||''-''||substr(trim(char('+B+')),7,2) ),0)+1)';
