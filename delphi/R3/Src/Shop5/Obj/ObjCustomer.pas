...
begin
  ...
  'on B.CLIENT_ID=A.CLIENT_ID and B.TENANT_ID=A.TENANT_ID where A.CLIENT_ID=:CLIENT_ID and A.TENANT_ID=:TENANT_ID and A.UNION_ID=:UNION_ID ';
  IsSQLUpdate := true;
  SQL :=
  ...
  SQL := 'update PUB_IC_INFO set IC_CARDNO=:IC_CARDNO,PASSWRD=:PASSWRD,BALANCE=:BALANCE,COMM='+GetCommStr(iDbType)+
  ',TIME_STAMP='+GetTimeStamp(iDbType)+' where TENANT_ID=:OLD_TENANT_ID and CLIENT_ID=:OLD_CLIENT_ID and UNION_ID=:UNION_ID';
  UpdateSQL.Text := SQL;
end;
