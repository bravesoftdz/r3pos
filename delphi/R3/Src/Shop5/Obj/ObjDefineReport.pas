...
begin
  inherited;
  SelectSQL.Text :=
  ' select ROWS_ID,TENANT_ID,REPORT_ID,CELL_TYPE,COL,ROW,DISPLAY_NAME,FIELD_NAME,INDEX_ID,SUM_TYPE from SYS_REPORT_TEMPLATE where TENANT_ID=:TENANT_ID and REPORT_ID=:REPORT_ID and CELL_TYPE=:CELL_TYPE ';
  IsSQLUpdate := True;

  Str := 'insert into SYS_REPORT_TEMPLATE(ROWS_ID,TENANT_ID,REPORT_ID,CELL_TYPE,COL,ROW,DISPLAY_NAME,FIELD_NAME,INDEX_ID,SUM_TYPE) '+
  ' VALUES(:ROWS_ID,:TENANT_ID,:REPORT_ID,:CELL_TYPE,:COL,:ROW,:DISPLAY_NAME,:FIELD_NAME,:INDEX_ID,:SUM_TYPE)';
  InsertSQL.Text := Str;
  ...
  'FIELD_NAME=:FIELD_NAME,INDEX_ID=:INDEX_ID,SUM_TYPE=:SUM_TYPE where TENANT_ID=:OLD_TENANT_ID and ROWS_ID=:OLD_ROWS_ID';
  UpdateSQL.Text := Str;
