...
begin
  ...
  lock := false;
  SelectSQL.Text :=
  'select TENANT_ID,SHOP_ID,DEMA_ID,DEMA_TYPE,GLIDE_NO,DEMA_DATE,CLIENT_ID,DEMA_USER,CHK_DATE,CHK_USER,REMARK,CREA_DATE,CREA_USER,DEMA_AMT,DEMA_MNY,COMM,TIME_STAMP from MKT_DEMANDORDER where TENANT_ID=:TENANT_ID and DEMA_ID=:DEMA_ID';
  IsSQLUpdate := True;
  Str :=
