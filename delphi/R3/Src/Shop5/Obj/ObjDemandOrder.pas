...
begin
  ...
  lock := false;
  SelectSQL.Text :=
  'select ja.TENANT_ID,ja.SHOP_ID,ja.DEMA_ID,ja.DEMA_TYPE,ja.GLIDE_NO,ja.DEMA_DATE,ja.CLIENT_ID,ja.DEMA_USER,ja.CHK_DATE,ja.CHK_USER,ja.REMARK,ja.CREA_DATE,ja.CREA_USER,ja.DEMA_AMT,ja.DEMA_MNY,ja.COMM,'+
  'ja.TIME_STAMP,a.USER_NAME as CHK_USER_TEXT from MKT_DEMANDORDER ja left join VIW_USERS a on ja.TENANT_ID=a.TENANT_ID and ja.CHK_USER=a.USER_ID where ja.TENANT_ID=:TENANT_ID and ja.DEMA_ID=:DEMA_ID';
  IsSQLUpdate := True;
  Str :=
  'insert into MKT_DEMANDORDER(TENANT_ID,SHOP_ID,DEMA_ID,DEMA_TYPE,GLIDE_NO,DEMA_DATE,CLIENT_ID,DEMA_USER,CHK_DATE,CHK_USER,REMARK,CREA_DATE,CREA_USER,DEMA_AMT,DEMA_MNY,COMM,TIME_STAMP) '+
  'VALUES(:TENANT_ID,:SHOP_ID,:DEMA_ID,:DEMA_TYPE,:GLIDE_NO,:DEMA_DATE,:CLIENT_ID,:DEMA_USER,:CHK_DATE,:CHK_USER,:REMARK,:CREA_DATE,:CREA_USER,:DEMA_AMT,:DEMA_MNY,''00'','+GetTimeStamp(iDbType)+')';
  InsertSQL.Text := Str;
  Str :=
  'update MKT_DEMANDORDER set TENANT_ID=:TENANT_ID,SHOP_ID=:SHOP_ID,DEMA_ID=:DEMA_ID,DEMA_TYPE=:DEMA_TYPE,GLIDE_NO=:GLIDE_NO,DEMA_DATE=:DEMA_DATE,'+
