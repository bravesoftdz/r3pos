...
begin
  ...
  IsSQLUpdate := True;
  InsertSQL.Text := ' insert into ACC_FVCHFRAME(TENANT_ID,FVCH_GTYPE,SEQNO,SUBJECT_NO,SUMMARY,AMONEY,AMOUNT,APRICE,SWHERE,DATAFLAG,SUBJECT_TYPE,FVCH_NAME) '+
                    ' values(:TENANT_ID,:FVCH_GTYPE,:SEQNO,:SUBJECT_NO,:SUMMARY,:AMONEY,:AMOUNT,:APRICE,:SWHERE,:DATAFLAG,:SUBJECT_TYPE,:FVCH_NAME)';
  ...
  UpdateSQL.Text := ' update ACC_FVCHFRAME set TENANT_ID=:TENANT_ID,FVCH_GTYPE=:FVCH_GTYPE,SEQNO=:SEQNO,SUBJECT_NO=:SUBJECT_NO,SUMMARY=:SUMMARY,'+
                    'AMONEY=:AMONEY,AMOUNT=:AMOUNT,APRICE=:APRICE,SWHERE=:SWHERE,DATAFLAG=:DATAFLAG,SUBJECT_TYPE=:SUBJECT_TYPE,FVCH_NAME=:FVCH_NAME '+
