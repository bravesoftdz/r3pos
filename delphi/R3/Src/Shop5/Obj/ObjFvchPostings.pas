...
function TFvchPostForInspur.DoCopyFvchOrder(AGlobal:IdbHelp;Params:TftParamList): Boolean;
var
  SQL: string;
  iRet: integer;
begin
...
function TFvchPostForInspur.DoCopyFvchData(AGlobal: IdbHelp; Params: TftParamList): Boolean;
var
  SQL: string;
  RecNo,iRet: integer;
begin
...
function TFvchPostForInspur.DoCopyFvchDetail(AGlobal: IdbHelp; Params: TftParamList): Boolean;
var
  SQL: string;
  RecNo,iRet: integer;
begin
...
constructor TFvchPostForInspur.Create(AGlobal: IdbHelp; Params: TftParamList);
begin
  inherited;
...
destructor TFvchPostForInspur.Destroy;
begin
  FvchOrder.Free;
  FvchData.Free;
  FvchDetail.Free;
...
function TFvchPostForInspur.OpenFvchData(AGlobal: IdbHelp; Params: TftParamList): Boolean;
var
  Rs: TZQuery;
...
function TFvchPostForInspur.UpdateOldOrderAndBM(AGlobal: IdbHelp; Params: TftParamList): Boolean;
var
  UpSQL: string;
begin               
  //更新
