...
begin
  ...
  SelectSQL.Text := 'select TENANT_ID,INVH_ID,SHOP_ID,CREA_USER,CREA_DATE,INVH_NO,BEGIN_NO,ENDED_NO,TOTAL_AMT,USING_AMT,CANCEL_AMT,'+
  'BALANCE,REMARK from SAL_INVOICE_BOOK where TENANT_ID = :TENANT_ID and INVH_ID = :INVH_ID order by CREA_DATE';
  IsSQLUpdate := True;

  Str := 'insert into SAL_INVOICE_BOOK(TENANT_ID,INVH_ID,SHOP_ID,CREA_USER,CREA_DATE,INVH_NO,BEGIN_NO,ENDED_NO,TOTAL_AMT,USING_AMT,'+
  'CANCEL_AMT,BALANCE,REMARK,COMM,TIME_STAMP) values(:TENANT_ID,:INVH_ID,:SHOP_ID,:CREA_USER,:CREA_DATE,:INVH_NO,:BEGIN_NO,'+
  ':ENDED_NO,:TOTAL_AMT,:USING_AMT,:CANCEL_AMT,:BALANCE,:REMARK,''00'','+GetTimeStamp(iDbType)+')';
  InsertSQL.Text :=Str;

  Str := 'update SAL_INVOICE_BOOK set TENANT_ID=:TENANT_ID,INVH_ID=:INVH_ID,SHOP_ID=:SHOP_ID,CREA_USER=:CREA_USER,CREA_DATE=:CREA_DATE,'+
  'INVH_NO=:INVH_NO,BEGIN_NO=:BEGIN_NO,ENDED_NO=:ENDED_NO,TOTAL_AMT=:TOTAL_AMT,USING_AMT=:USING_AMT,CANCEL_AMT=:CANCEL_AMT,BALANCE=:BALANCE,'+
