...
begin
  ...
  SelectSQL.Text :=
  'select TENANT_ID,KPI_ID,KPI_NAME,UNIT_NAME,IDX_TYPE,KPI_TYPE,KPI_DATA,KPI_CALC,KPI_AGIO,KPI_OPTN,REMARK from MKT_KPI_INDEX '+
  'where TENANT_ID=:TENANT_ID and KPI_ID=:KPI_ID and COMM not in (''02'',''12'') ';

  IsSQLUpdate := True;
  Str := 'insert into MKT_KPI_INDEX(TENANT_ID,KPI_ID,KPI_NAME,UNIT_NAME,IDX_TYPE,KPI_TYPE,KPI_DATA,KPI_CALC,KPI_AGIO,KPI_OPTN,REMARK,COMM,TIME_STAMP) '+
         ' VALUES(:TENANT_ID,:KPI_ID,:KPI_NAME,:UNIT_NAME,:IDX_TYPE,:KPI_TYPE,:KPI_DATA,:KPI_CALC,:KPI_AGIO,:KPI_OPTN,:REMARK,''00'','+GetTimeStamp(iDbType)+')';
  InsertSQL.Add( Str);
