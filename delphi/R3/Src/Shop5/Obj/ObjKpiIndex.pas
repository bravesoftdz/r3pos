...
begin
  ...
  Str :=
    ...
    ' where TENANT_ID=:OLD_TENANT_ID and KPI_ID=:OLD_KPI_ID and TIMES_ID=:OLD_TIMES_ID';
  UpdateSQL.Add( Str);
  Str := 'delete from MKT_KPI_TIMES where TENANT_ID=:OLD_TENANT_ID and KPI_ID=:OLD_KPI_ID and TIMES_ID=:OLD_TIMES_ID';
  DeleteSQL.Add( Str);
end;
