...
begin
  ...
  'A.REQU_TYPE,A.GLIDE_NO,A.REQU_DATE,A.CLIENT_ID,D.PRICE_ID,D.CLIENT_NAME as CLIENT_ID_TEXT,E.USER_NAME as REQU_USER_TEXT,'+
...
begin
  ...
  'case when A.UNIT_ID=B.UNIT_ID then isnull(B.NEW_OUTPRICE,0) when A.UNIT_ID=B.SMALL_UNITS then isnull(B.[NEW_OUTPRICE],0)*B.SMALLTO_CALC '+
