...
begin
  ...
  Str := 'insert into MKT_REQUORDER(TENANT_ID,SHOP_ID,REQU_ID,IORO_ID,DEPT_ID,REQU_TYPE,GLIDE_NO,REQU_DATE,CLIENT_ID,REQU_USER,CHK_DATE,CHK_USER,REQU_MNY,REMARK,CREA_DATE,CREA_USER,COMM,TIME_STAMP) '
    + 'VALUES(:TENANT_ID,:SHOP_ID,:REQU_ID,:IORO_ID,:DEPT_ID,:REQU_TYPE,:GLIDE_NO,:REQU_DATE,:CLIENT_ID,:REQU_USER,:CHK_DATE,:CHK_USER,:REQU_MNY,:REMARK,:CREA_DATE,:CREA_USER,''00'','+GetTimeStamp(iDbType)+')';
  InsertSQL.Text := Str;
  Str := 'update MKT_REQUORDER set TENANT_ID=:TENANT_ID,SHOP_ID=:SHOP_ID,REQU_ID=:REQU_ID,IORO_ID=:IORO_ID,DEPT_ID=:DEPT_ID,REQU_TYPE=:REQU_TYPE,GLIDE_NO=:GLIDE_NO,REQU_DATE=:REQU_DATE,'+
