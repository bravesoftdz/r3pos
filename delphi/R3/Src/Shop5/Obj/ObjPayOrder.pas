...
begin
  ...
  'select A.PAY_ID,A.SHOP_ID,A.TENANT_ID,A.GLIDE_NO,A.CLIENT_ID,A.ACCOUNT_ID,B.ACCT_NAME as ACCOUNT_ID_TEXT,A.PAYM_ID,A.PAY_MNY,A.ITEM_ID,A.PAY_DATE,A.PAY_USER,A.CHK_DATE,A.CHK_USER,A.REMARK,A.COMM,A.CREA_DATE,A.CREA_USER,A.TIME_STAMP '+
  ...
  IsSQLUpdate := True;
  Str := 'insert into ACC_PAYORDER(PAY_ID,TENANT_ID,SHOP_ID,GLIDE_NO,ACCOUNT_ID,PAYM_ID,PAY_MNY,CLIENT_ID,ITEM_ID,PAY_DATE,PAY_USER,CHK_DATE,CHK_USER,COMM,CREA_DATE,CREA_USER,REMARK,TIME_STAMP) '
