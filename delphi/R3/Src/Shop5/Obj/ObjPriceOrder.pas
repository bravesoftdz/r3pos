...
begin
  ...
  SelectSQL.Text:='select * From  '+
    ...
    ',j.USING_LEVEL as USING_LEVEL,j.LVL_TYPE as LVL_TYPE'+
    ',j.LV1_AMT as LV1_AMT,j.LV2_AMT as LV2_AMT,j.LV3_AMT as LV3_AMT,j.LV4_AMT as LV4_AMT,j.LV5_AMT as LV5_AMT,j.LV6_AMT as LV6_AMT,j.LV7_AMT as LV7_AMT,j.LV8_AMT as LV8_AMT,j.LV9_AMT as LV9_AMT'+
    ',j.LV1_PRC as LV1_PRC,j.LV2_PRC as LV2_PRC,j.LV3_PRC as LV3_PRC,j.LV4_PRC as LV4_PRC,j.LV5_PRC as LV5_PRC,j.LV6_PRC as LV6_PRC,j.LV7_PRC as LV7_PRC,j.LV8_PRC as LV8_PRC,j.LV9_PRC as LV9_PRC'+
  ...
  Str:='Insert Into SAL_PRICEDATA(PROM_ID,TENANT_ID,SEQNO,GODS_ID,NEW_OUTPRICE,NEW_OUTPRICE1,NEW_OUTPRICE2,RATE_OFF,AGIO_RATE,ISINTEGRAL'+
        ',USING_LEVEL,LVL_TYPE,LV1_AMT,LV2_AMT,LV3_AMT,LV4_AMT,LV5_AMT,LV6_AMT,LV7_AMT,LV8_AMT,LV9_AMT'+
        ',LV1_PRC,LV2_PRC,LV3_PRC,LV4_PRC,LV5_PRC,LV6_PRC,LV7_PRC,LV8_PRC,LV9_PRC) '+
  ...
  Str:='update SAL_PRICEDATA set PROM_ID=:PROM_ID,TENANT_ID=:TENANT_ID,SEQNO=:SEQNO,GODS_ID=:GODS_ID,NEW_OUTPRICE=:OUT_PRICE,NEW_OUTPRICE1=:OUT_PRICE1,NEW_OUTPRICE2=:OUT_PRICE2,RATE_OFF=:RATE_OFF,AGIO_RATE=:AGIO_RATE,ISINTEGRAL=:ISINTEGRAL '+
        ',USING_LEVEL =:USING_LEVEL,LVL_TYPE =:LVL_TYPE'+
        ',LV1_AMT =:LV1_AMT,LV2_AMT =:LV2_AMT,LV3_AMT =:LV3_AMT,LV4_AMT =:LV4_AMT,LV5_AMT =:LV5_AMT,LV6_AMT =:LV6_AMT,LV7_AMT =:LV7_AMT,LV8_AMT =:LV8_AMT,LV9_AMT =:LV9_AMT'+
        ',LV1_PRC =:LV1_PRC,LV2_PRC =:LV2_PRC,LV3_PRC =:LV3_PRC,LV4_PRC =:LV4_PRC,LV5_PRC =:LV5_PRC,LV6_PRC =:LV6_PRC,LV7_PRC =:LV7_PRC,LV8_PRC =:LV8_PRC,LV9_PRC =:LV9_PRC'+
...
begin
  ...
  1:SelectSQL.Text := 'select * from (select PROM_ID from SAL_PRICEORDER where TENANT_ID=:TENANT_ID and CREA_USER=:CREA_USER and GLIDE_NO<:GLIDE_NO order by GLIDE_NO desc) where ROWNUM<2 ';
...
begin
  ...
  case iDbType of
   ...
   1:SelectSQL.Text := 'select * from (select PROM_ID from SAL_PRICEORDER where TENANT_ID=:TENANT_ID and CREA_USER=:CREA_USER and GLIDE_NO>:GLIDE_NO order by GLIDE_NO) where ROWNUM<2 ';
