...
begin
  ...
  begin
    Str:='insert into STO_PRINTDATA(ROWS_ID,TENANT_ID,SHOP_ID,PRINT_DATE,BATCH_NO,LOCUS_NO,BOM_ID,GODS_ID,PROPERTY_01,PROPERTY_02,RCK_AMOUNT,CHK_AMOUNT,CHECK_STATUS) '+
         ' values (:ROWS_ID,:TENANT_ID,:SHOP_ID,:PRINT_DATE,:BATCH_NO,null,null,:GODS_ID,:PROPERTY_01,:PROPERTY_02,0.000,:CALC_AMOUNT,''2'')';
    AGlobal.ExecSQL(str, self);
  end;
  str:='update STO_PRINTDATA set CHK_AMOUNT=0,CHECK_STATUS=''2'' '+
    ' where TENANT_ID=:TENANT_ID and SHOP_ID=:SHOP_ID and PRINT_DATE=:PRINT_DATE and GODS_ID=:GODS_ID and BATCH_NO=:BATCH_NO and CHECK_STATUS<>''2'' ';
  AGlobal.ExecSQL(str,self);
  result := true;
end;
...
begin
  ...
  SelectSQL.Text:=
    ParseSQL(iDbType,
    'select j.ROWS_ID as ROWS_ID,j.TENANT_ID as TENANT_ID,j.SHOP_ID as SHOP_ID,j.PRINT_DATE as PRINT_DATE,j.GODS_ID as GODS_ID,j.PROPERTY_01 as PROPERTY_01,0 as IS_PRESENT,'+
    ...
    ' inner join VIW_GOODSPRICEEXT b on j.TENANT_ID=b.TENANT_ID and j.SHOP_ID=b.SHOP_ID and j.GODS_ID=b.GODS_ID '+
