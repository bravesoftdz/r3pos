...
begin
  ...
  'A.RECV_DATE,A.RECV_USER,A.RECV_MNY,A.CHK_DATE,A.CHK_USER,A.REMARK,A.COMM,A.CREA_DATE,A.CREA_USER,A.TIME_STAMP '+
  ...
  IsSQLUpdate := True;
  Str := 'insert into ACC_RECVORDER(TENANT_ID,RECV_ID,SHOP_ID,GLIDE_NO,ACCOUNT_ID,PAYM_ID,RECV_MNY,CLIENT_ID,ITEM_ID,RECV_DATE,RECV_USER,CHK_DATE,CHK_USER,COMM,CREA_DATE,CREA_USER,REMARK,TIME_STAMP) '
