...
begin
  inherited;
  SelectSQL.Text:= 'select ROWS_ID,TENANT_ID,MODU_ID,ROLE_ID,ROLE_TYPE,CHK from CA_RIGHTS where ROLE_TYPE=1 and TENANT_ID=:TENANT_ID and ROLE_ID=:ROLE_ID ';
  ...
  UpdateSQL.Add(Str);
  case iDbType of
   0: Str:='delete CA_RIGHTS where TENANT_ID=:OLD_TENANT_ID and ROWS_ID=:OLD_ROWS_ID ';
   3,5:
      Str:='delete from CA_RIGHTS where TENANT_ID=:OLD_TENANT_ID and ROWS_ID=:OLD_ROWS_ID ';
  end;
  DeleteSQL.Add(Str);
end;
