...
begin
  ...
  Str := 'insert into SAL_INDENTDATA(TENANT_ID,SHOP_ID,INDE_ID,SEQNO,GODS_ID,PROPERTY_01,PROPERTY_02,BATCH_NO,BOM_ID,LOCUS_NO,UNIT_ID,AMOUNT,ORG_PRICE,POLICY_TYPE,IS_PRESENT,APRICE,AMONEY,AGIO_RATE,AGIO_MONEY,CALC_AMOUNT,CALC_MONEY,BOND_MNY,HAS_INTEGRAL,REMARK) '
    + 'VALUES(:TENANT_ID,:SHOP_ID,:INDE_ID,:SEQNO,:GODS_ID,:PROPERTY_01,:PROPERTY_02,:BATCH_NO,:BOM_ID,:LOCUS_NO,:UNIT_ID,:AMOUNT,:ORG_PRICE,:POLICY_TYPE,:IS_PRESENT,:APRICE,:AMONEY,:AGIO_RATE,:AGIO_MONEY,:CALC_AMOUNT,:CALC_MONEY,:BOND_MNY,:HAS_INTEGRAL,:REMARK)';
  InsertSQL.Text := Str;
  Str := 'update SAL_INDENTDATA set TENANT_ID=:TENANT_ID,SHOP_ID=:SHOP_ID,INDE_ID=:INDE_ID,SEQNO=:SEQNO,GODS_ID=:GODS_ID,PROPERTY_01=:PROPERTY_01,PROPERTY_02=:PROPERTY_02,BATCH_NO=:BATCH_NO,BOM_ID=:BOM_ID,LOCUS_NO=:LOCUS_NO,UNIT_ID=:UNIT_ID,'+
      'AMOUNT=:AMOUNT,ORG_PRICE=:ORG_PRICE,POLICY_TYPE=:POLICY_TYPE,IS_PRESENT=:IS_PRESENT,APRICE=:APRICE,AMONEY=:AMONEY,AGIO_RATE=:AGIO_RATE,AGIO_MONEY=:AGIO_MONEY,CALC_AMOUNT=:CALC_AMOUNT,BOND_MNY=:BOND_MNY,'+
