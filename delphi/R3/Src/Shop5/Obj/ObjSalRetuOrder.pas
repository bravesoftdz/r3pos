  ...
  begin
     ...
     begin
       ...
       AGlobal.ExecSQL(
         ...
         + 'VALUES('''+newid(FieldbyName('SHOP_ID').asString)+''',:TENANT_ID,:SHOP_ID,:DEPT_ID,:CLIENT_ID,'''+'销售退款【退货单号'+FieldbyName('GLIDE_NO').AsString+'】'+''',''2'',- :PAY_D,0,- :ADVA_MNY,- :PAY_D,:SALES_DATE,:SALES_ID,:CREA_DATE,:CREA_USER,''00'','+GetTimeStamp(iDbType)+')'
      ,self);
     end;
     {
