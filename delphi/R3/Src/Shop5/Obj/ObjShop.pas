...
begin
  ...
  +'REMARK=:REMARK,LINKMAN=:LINKMAN,REGION_ID=:REGION_ID,SEQ_NO=:SEQ_NO,COMM='+GetCommStr(iDbType)+',TIME_STAMP='+GetTimeStamp(iDbType)+' where SHOP_ID=:OLD_SHOP_ID and TENANT_ID=:OLD_TENANT_ID';
  UpdateSQL.Text := Str;
