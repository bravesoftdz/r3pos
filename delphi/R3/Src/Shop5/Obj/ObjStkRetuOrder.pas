  ...
  begin
     ...
     begin
       ...
       AGlobal.ExecSQL(
         ...
         + 'VALUES('''+newid(FieldbyName('SHOP_ID').asString)+''',:TENANT_ID,:SHOP_ID,:CLIENT_ID,'''+'进货退款【退货单号'+FieldbyName('GLIDE_NO').AsString+'】'+''',''5'',- :STOCK_MNY,0,- :ADVA_MNY,- :STOCK_MNY,:STOCK_DATE,:STOCK_ID,:CREA_DATE,:CREA_USER,''00'','+GetTimeStamp(iDbType)+')'
      ,self);
     end;
  end;
  result := true;
