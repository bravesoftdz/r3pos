...
begin
  ...
  4:SelectSQL.Text := 'select * from (select STOCK_ID from STK_STOCKORDER where SHOP_ID=:SHOP_ID and TENANT_ID=:TENANT_ID and CREA_USER=:CREA_USER and GLIDE_NO<:GLIDE_NO and STOCK_TYPE=:STOCK_TYPE order by GLIDE_NO desc) where ROWNUM=1';
...
begin
  ...
  4:SelectSQL.Text := 'select * from (select STOCK_ID from STK_STOCKORDER where SHOP_ID=:SHOP_ID and TENANT_ID=:TENANT_ID and CREA_USER=:CREA_USER and GLIDE_NO>:GLIDE_NO and STOCK_TYPE=:STOCK_TYPE order by GLIDE_NO) where ROWNUM=1';
