...
begin
  ...
  SelectSQL.Text:='select TENANT_ID,CLIENT_ID,CLIENT_TYPE,CLIENT_CODE,LICENSE_CODE,CLIENT_NAME,CLIENT_SPELL,SORT_ID,REGION_ID,'+
  'SETTLE_CODE,PRICE_ID,SHOP_ID,TAX_RATE,ADDRESS,POSTALCODE,LINKMAN,TELEPHONE3,TELEPHONE1,TELEPHONE2,SEND_ADDR,SEND_TELE,SEND_LINKMAN,'+
  'RECV_ADDR,RECV_LINKMAN,RECV_TELE,LEGAL_REPR,INVO_NAME,TAX_NO,FAXES,HOMEPAGE,EMAIL,QQ,MSN,BANK_ID,ACCOUNT,INVOICE_FLAG,REMARK'+
  ...
  'RECV_LINKMAN,RECV_TELE,LEGAL_REPR,INVO_NAME,TAX_NO,FAXES,HOMEPAGE,EMAIL,QQ,MSN,BANK_ID,ACCOUNT,INVOICE_FLAG,REMARK,TAX_RATE,'+
  'SHOP_ID,COMM,TIME_STAMP) values(:TENANT_ID,:CLIENT_ID,:CLIENT_TYPE,:CLIENT_CODE,:LICENSE_CODE,:CLIENT_NAME,:CLIENT_SPELL,:SORT_ID,'+
  ':REGION_ID,:SETTLE_CODE,:ADDRESS,:POSTALCODE,:LINKMAN,:TELEPHONE3,:TELEPHONE1,:TELEPHONE2,:SEND_ADDR,:SEND_TELE,:SEND_LINKMAN,'+
  ':RECV_ADDR,:RECV_LINKMAN,:RECV_TELE,:LEGAL_REPR,:INVO_NAME,:TAX_NO,:FAXES,:HOMEPAGE,:EMAIL,:QQ,:MSN,:BANK_ID,:ACCOUNT,:INVOICE_FLAG,'+
  ':REMARK,:TAX_RATE,:SHOP_ID,''00'','+GetTimeStamp(iDbType)+')';
  InsertSQL.Text := Str;
  ...
  'TELEPHONE1=:TELEPHONE1,TELEPHONE2=:TELEPHONE2,SEND_ADDR=:SEND_ADDR,SEND_TELE=:SEND_TELE,SEND_LINKMAN=:SEND_LINKMAN,RECV_ADDR=:RECV_ADDR,'+
  'RECV_LINKMAN=:RECV_LINKMAN,RECV_TELE=:RECV_TELE,LEGAL_REPR=:LEGAL_REPR,INVO_NAME=:INVO_NAME,TAX_NO=:TAX_NO,FAXES=:FAXES,HOMEPAGE=:HOMEPAGE,'+
  'EMAIL=:EMAIL,QQ=:QQ,MSN=:MSN,BANK_ID=:BANK_ID,ACCOUNT=:ACCOUNT,INVOICE_FLAG=:INVOICE_FLAG,REMARK=:REMARK,TAX_RATE=:TAX_RATE,SHOP_ID=:SHOP_ID,COMM='+ GetCommStr(iDbType)+
