...
begin
  ...
  Str := 'insert into CA_SHOP_INFO(SHOP_ID,LICENSE_CODE,SHOP_NAME,SHOP_SPELL,SHOP_TYPE,TENANT_ID,LINKMAN,TELEPHONE,ADDRESS,COMM,TIME_STAMP) values(:TENANT_ID * 10000+1,'+
  ':LICENSE_CODE,:SHORT_TENANT_NAME,:TENANT_SPELL,''1'',:TENANT_ID,:LINKMAN,:TELEPHONE,:ADDRESS,''00'','+GetTimeStamp(AGlobal.iDbType)+')';
  AGlobal.ExecSQL(Str,Self);
