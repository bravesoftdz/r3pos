...
begin
  ...
  Str := 'insert into CA_SHOP_INFO(SHOP_ID,LICENSE_CODE,SHOP_NAME,SHOP_SPELL,SHOP_TYPE,TENANT_ID,REGION_ID,SEQ_NO,LINKMAN,TELEPHONE,ADDRESS,POSTALCODE,FAXES,COMM,TIME_STAMP) values(:TENANT_ID*10000+1,'+
  ':LICENSE_CODE,:SHORT_TENANT_NAME,:TENANT_SPELL,''1'',:TENANT_ID,:REGION_ID,1,:LINKMAN,:TELEPHONE,:ADDRESS,:POSTALCODE,:FAXES,''00'','+GetTimeStamp(AGlobal.iDbType)+')';
  AGlobal.ExecSQL(Str,Self);
