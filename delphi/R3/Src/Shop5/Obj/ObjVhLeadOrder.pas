...
begin
  ...
  Locked := false;
  SelectSQL.Text :=
  ' select A.TENANT_ID,A.VHLEAD_ID,A.SHOP_ID,C.SHOP_NAME as SHOP_ID_TEXT,A.DEPT_ID,B.DEPT_NAME as DEPT_ID_TEXT,'+
  'A.LEAD_DATE,A.LEAD_USER,E.USER_NAME as LEAD_USER_TEXT,A.CREA_DATE,A.CREA_USER,D.USER_NAME as CREA_USER_TEXT,A.REMARK,A.COMM '+
