...
begin
  ...
  IsSQLUpdate := True;
  Str := ' insert into SAL_VOUCHERORDER(TENANT_ID,VOUCHER_ID,SHOP_ID,DEPT_ID,VOUCHER_TYPE,INTO_DATE,INTO_USER,CREA_DATE,CREA_USER,VAILD_DATE,VUCH_NAME,REMARK,COMM,TIME_STAMP) '+
  ' VALUES(:TENANT_ID,:VOUCHER_ID,:SHOP_ID,:DEPT_ID,:VOUCHER_TYPE,:INTO_DATE,:INTO_USER,:CREA_DATE,:CREA_USER,:VAILD_DATE,:VUCH_NAME,:REMARK,''00'','+GetTimeStamp(iDbType)+')';
  InsertSQL.Text := Str;
  Str := ' update SAL_VOUCHERORDER set TENANT_ID=:TENANT_ID,SHOP_ID=:SHOP_ID,DEPT_ID=:DEPT_ID,VOUCHER_TYPE=:VOUCHER_TYPE,INTO_DATE=:INTO_DATE,'+
         'INTO_USER=:INTO_USER,CREA_DATE=:CREA_DATE,CREA_USER=:CREA_USER,VAILD_DATE=:VAILD_DATE,VUCH_NAME=:VUCH_NAME,REMARK=:REMARK,'+
