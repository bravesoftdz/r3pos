...
begin
  ...
  'select TENANT_ID,MSG_ID,MSG_CLASS,ISSUE_DATE,ISSUE_TENANT_ID,MSG_SOURCE,ISSUE_USER,MSG_TITLE,MSG_CONTENT,END_DATE,COMM from MSC_MESSAGE '+
  ...
  SelectSQL.Text := Str;
  IsSQLUpdate := True;
  Str := 'insert into MSC_MESSAGE(TENANT_ID,MSG_ID,MSG_CLASS,ISSUE_DATE,ISSUE_TENANT_ID,MSG_SOURCE,ISSUE_USER,MSG_TITLE,MSG_CONTENT,END_DATE,COMM,TIME_STAMP) '+
  'values(:TENANT_ID,:MSG_ID,:MSG_CLASS,:ISSUE_DATE,:ISSUE_TENANT_ID,:MSG_SOURCE,:ISSUE_USER,:MSG_TITLE,:MSG_CONTENT,:END_DATE,''00'','+GetTimeStamp(iDbType)+')';
  InsertSQL.Text := Str;
