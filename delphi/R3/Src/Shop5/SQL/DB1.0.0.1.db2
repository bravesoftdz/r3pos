...
CREATE INDEX I_CRTS_TENANT_ID ON CA_RIGHTS(TENANT_ID);

CREATE INDEX I_CRTS_MODU_ID ON CA_RIGHTS(TENANT_ID,ROLE_ID);

CREATE INDEX I_CRTS_TIME_STAMP ON CA_RIGHTS(TENANT_ID,TIME_STAMP);
...
CREATE INDEX I_LPRG_PRICING_DATE ON LOG_PRICING_INFO(TENANT_ID,PRICING_DATE);
...
CREATE INDEX I_SSKD_TENANT_ID ON STK_STOCKDATA(TENANT_ID);
...
CREATE INDEX I_APDR_INFO_CLIENT_ID ON ACC_PAYORDER(CLIENT_ID);
...
CREATE INDEX I_ARVD_INFO_CLIENT_ID ON ACC_RECVORDER(CLIENT_ID);
