...
CONSTRAINT [PK_PUB_PARAMS] PRIMARY KEY CLUSTERED 
(
	[CODE_ID],
	[TYPE_CODE] 
) ON [PRIMARY]
...
GO
CREATE INDEX IX_PUB_PARAMS_TYPE_CODE ON PUB_PARAMS(TYPE_CODE) ON [PRIMARY]
GO
CREATE INDEX IX_PUB_PARAMS_TIME_STAMP ON PUB_PARAMS(TIME_STAMP) ON [PRIMARY]
GO
--企业类型
...
CREATE TABLE [CA_TENANT](
    ...
    --更新时间 重2011-01-01开始的秒数  
	[TIME_STAMP] [bigint] NOT NULL,
 CONSTRAINT [PK_CA_TENANT] PRIMARY KEY CLUSTERED 
(
	[TENANT_ID] 
) ON [PRIMARY]
) ON [PRIMARY]
GO
CREATE INDEX IX_CA_TENANT_TIME_STAMP ON CA_TENANT(TIME_STAMP) ON [PRIMARY]
GO
---关系类型
...
GO
CREATE INDEX IX_CA_RELATIONS_TENANT_ID ON CA_RELATIONS(TENANT_ID) ON [PRIMARY]
GO
CREATE INDEX IX_CA_RELATIONS_RELATI_ID ON CA_RELATIONS(RELATI_ID) ON [PRIMARY]
GO
CREATE INDEX IX_CA_RELATIONS_LEVEL_ID ON CA_RELATIONS(LEVEL_ID) ON [PRIMARY]
GO
CREATE INDEX IX_CA_RELATIONS_TIME_STAMP ON CA_RELATIONS(TIME_STAMP) ON [PRIMARY]
GO
--部门资料
CREATE TABLE [CA_DEPT_INFO](
    ...
    --更新时间 重2011-01-01开始的秒数  
	[TIME_STAMP] [bigint] NOT NULL,
 CONSTRAINT [PK_CA_DEPT_INFO] PRIMARY KEY CLUSTERED 
(
	[DEPT_ID] 
) ON [PRIMARY]
) ON [PRIMARY]
GO
CREATE INDEX IX_CA_DEPT_INFO_TENANT_ID ON CA_DEPT_INFO(TENANT_ID) ON [PRIMARY]
GO
CREATE INDEX IX_CA_DEPT_INFO_TIME_STAMP ON CA_DEPT_INFO(TIME_STAMP) ON [PRIMARY]
GO
...
CREATE TABLE [CA_SHOP_INFO](
    ...
    --更新时间 重2011-01-01开始的秒数  
	[TIME_STAMP] [bigint] NOT NULL,
 CONSTRAINT [PK_CA_SHOP_INFO] PRIMARY KEY CLUSTERED 
(
	[SHOP_ID] 
) ON [PRIMARY]
) ON [PRIMARY]
GO
CREATE INDEX IX_CA_SHOP_INFO_TENANT_ID ON CA_SHOP_INFO(TENANT_ID) ON [PRIMARY]
GO
CREATE INDEX IX_CA_SHOP_INFO_TIME_STAMP ON CA_SHOP_INFO(TIME_STAMP) ON [PRIMARY]
GO
--职务资料
CREATE TABLE [CA_DUTY_INFO](
    ...
    --更新时间 重2011-01-01开始的秒数  
	[TIME_STAMP] [bigint] NOT NULL,
 CONSTRAINT [PK_CA_DUTY_INFO] PRIMARY KEY CLUSTERED 
(
	[DUTY_ID] 
) ON [PRIMARY]
) ON [PRIMARY]
GO
CREATE INDEX IX_CA_DUTY_INFO_TENANT_ID ON CA_DUTY_INFO(TENANT_ID) ON [PRIMARY]
GO
CREATE INDEX IX_CA_DUTY_INFO_TIME_STAMP ON CA_DUTY_INFO(TIME_STAMP) ON [PRIMARY]
GO
--角色资料
CREATE TABLE [CA_ROLE_INFO](
    ...
    --更新时间 重2011-01-01开始的秒数  
	[TIME_STAMP] [bigint] NOT NULL,
 CONSTRAINT [PK_CA_ROLE_INFO] PRIMARY KEY CLUSTERED 
(
	[ROLE_ID] 
) ON [PRIMARY]
) ON [PRIMARY]
GO
CREATE INDEX IX_CA_ROLE_INFO_TENANT_ID ON CA_ROLE_INFO(TENANT_ID) ON [PRIMARY]
GO
CREATE INDEX IX_CA_ROLE_INFO_TIME_STAMP ON CA_ROLE_INFO(TIME_STAMP) ON [PRIMARY]
GO
--用户资料
...
GO
CREATE INDEX IX_CA_USERS_TENANT_ID ON CA_USERS(TENANT_ID) ON [PRIMARY]
GO
CREATE INDEX IX_CA_USERS_ACCOUNT ON CA_USERS(ACCOUNT) ON [PRIMARY]
GO
CREATE INDEX IX_CA_USERS_ENCODE ON CA_USERS(ENCODE) ON [PRIMARY]
GO
CREATE INDEX IX_CA_USERS_TIME_STAMP ON CA_USERS(TIME_STAMP) ON [PRIMARY]
GO
--其他资料
CREATE TABLE [PUB_CODE_INFO](
    ...
    --更新时间 重2011-01-01开始的秒数  
	[TIME_STAMP] [bigint] NOT NULL,
 CONSTRAINT [PK_PUB_CODE_INFO] PRIMARY KEY CLUSTERED 
(
	[CODE_ID] ,
	[CODE_TYPE] 
) ON [PRIMARY]
...
GO
CREATE INDEX IX_PUB_CODE_INFO_CODE_TYPE ON PUB_CODE_INFO(CODE_TYPE) ON [PRIMARY]
GO
CREATE INDEX IX_PUB_CODE_INFO_TIME_STAMP ON PUB_CODE_INFO(TIME_STAMP) ON [PRIMARY]
GO
--服务器路由表
CREATE TABLE [PUB_SERVER_INFO](
    ...
    --更新时间 重2011-01-01开始的秒数  
	[TIME_STAMP] [bigint] NOT NULL,
 CONSTRAINT [PK_PUB_SERVER_INFO] PRIMARY KEY CLUSTERED 
(
	[SRVR_ID] 
) ON [PRIMARY]
) ON [PRIMARY]
GO
CREATE INDEX IX_PUB_SERVER_INFO_TIME_STAMP ON PUB_SERVER_INFO(TIME_STAMP) ON [PRIMARY]
GO
--服务器状态
...
CREATE TABLE [PUB_SN_INFO](
    ...
    --更新时间 重2011-01-01开始的秒数  
	[TIME_STAMP] [bigint] NOT NULL,
 CONSTRAINT [PK_PUB_SN_INFO] PRIMARY KEY CLUSTERED 
(
	[SN] 
) ON [PRIMARY]
) ON [PRIMARY]
GO
CREATE INDEX IX_PUB_SN_INFO_SN ON PUB_SN_INFO(SN) ON [PRIMARY]
GO
CREATE INDEX IX_PUB_SN_INFO_TIME_STAMP ON PUB_SN_INFO(TIME_STAMP) ON [PRIMARY]
GO
...
GO
 insert into PUB_CODE_INFO(code_id,code_name,code_spell,code_type,seq_no,comm,time_stamp) values('1','总店','ZD','12','1','00',convert(bigint,(convert(float,getdate())-40542.0)*86400))
 insert into PUB_CODE_INFO(code_id,code_name,code_spell,code_type,seq_no,comm,time_stamp) values('2','门店','MD','12','2','00',convert(bigint,(convert(float,getdate())-40542.0)*86400))
GO
