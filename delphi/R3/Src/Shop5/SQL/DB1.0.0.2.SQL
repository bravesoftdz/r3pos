...
CREATE INDEX IX_MSC_INVEST_LIST_QUESTION_ID ON MSC_INVEST_LIST(TENANT_ID,QUESTION_ID);
...
CREATE INDEX IX_MSC_INVEST_ANSWER_QUESTION_ID ON MSC_INVEST_ANSWER(TENANT_ID,QUESTION_ID);
