...
--添加指标<以下指票UNION ALL所有指标，为报表所能使用的所有指标，数据源必须提供这些指标>
 ...
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('CREGION_ID','客户所在地区','INDEX_TYPE1','00',5497000);
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('SREGION_ID','门店所在地区','INDEX_TYPE1','00',5497000);

 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('CLIENT_ID','供应商','INDEX_TYPE2','00',5497000);
 ...
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('CREGION_ID','客户所在地区','INDEX_TYPE2','00',5497000);
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('SREGION_ID','门店所在地区','INDEX_TYPE2','00',5497000);
 ...
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('SREGION_ID','门店所在地区','INDEX_TYPE3','00',5497000);
