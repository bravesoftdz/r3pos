update CA_MODULE set MODU_NAME='赠送/兑换' where MODU_ID='13100007';
update CA_MODULE set MODU_NAME='抹零' where MODU_ID='13100008';
update CA_MODULE set MODU_NAME='赠送/兑换' where MODU_ID='12400007';
update CA_MODULE set MODU_NAME='赠送/兑换' where MODU_ID='12500007';
update CA_MODULE set MODU_NAME='赠送/兑换' where MODU_ID='12300007';
update CA_MODULE set MODU_NAME='赠送/兑换' where MODU_ID='12300007';
...
delete from CA_MODULE where MODU_ID like '427%'; 
delete from CA_MODULE where MODU_ID like '428%';

insert into CA_MODULE(PROD_ID,MODU_ID,SEQNO,MODU_NAME,LEVEL_ID,MODU_TYPE,ACTION_NAME,ACTION_URL,COMM,TIME_STAMP)
values('R3_RYC','42800001',0,'动销分析报表','004003007',1,'actfrmSaleMonthTotalReport','#','00',5497000);
insert into CA_MODULE(PROD_ID,MODU_ID,SEQNO,MODU_NAME,LEVEL_ID,MODU_TYPE,ACTION_NAME,ACTION_URL,COMM,TIME_STAMP)
values('R3_RYC','42800002',1,'查询','004003007002',2,'#','#','00',5497000);
insert into CA_MODULE(PROD_ID,MODU_ID,SEQNO,MODU_NAME,LEVEL_ID,MODU_TYPE,ACTION_NAME,ACTION_URL,COMM,TIME_STAMP)
values('R3_RYC','42800003',2,'打印','004003007003',2,'#','#','00',5497000);
insert into CA_MODULE(PROD_ID,MODU_ID,SEQNO,MODU_NAME,LEVEL_ID,MODU_TYPE,ACTION_NAME,ACTION_URL,COMM,TIME_STAMP)
values('R3_RYC','42800004',3,'导出','004003007004',2,'#','#','00',5497000);


insert into CA_MODULE(PROD_ID,MODU_ID,SEQNO,MODU_NAME,LEVEL_ID,MODU_TYPE,ACTION_NAME,ACTION_URL,COMM,TIME_STAMP)
values('R3_RYC','42700001',0,'市场分析报表','004003008',1,'actfrmSaleAnaly','#','00',5497000);
insert into CA_MODULE(PROD_ID,MODU_ID,SEQNO,MODU_NAME,LEVEL_ID,MODU_TYPE,ACTION_NAME,ACTION_URL,COMM,TIME_STAMP)
values('R3_RYC','42700002',1,'查询','004003008002',2,'#','#','00',5497000);
insert into CA_MODULE(PROD_ID,MODU_ID,SEQNO,MODU_NAME,LEVEL_ID,MODU_TYPE,ACTION_NAME,ACTION_URL,COMM,TIME_STAMP)
values('R3_RYC','42700003',2,'打印','004003008003',2,'#','#','00',5497000);
insert into CA_MODULE(PROD_ID,MODU_ID,SEQNO,MODU_NAME,LEVEL_ID,MODU_TYPE,ACTION_NAME,ACTION_URL,COMM,TIME_STAMP)
values('R3_RYC','42700004',3,'导出','004003008004',2,'#','#','00',5497000);
...
XSM_PSWD as PASS_WRD,trim(char(TENANT_ID))||'001' as DEPT_ID, '00' as COMM from CA_SHOP_INFO where XSM_CODE is not null;
