...
CREATE INDEX IX_MPNR_TENANT_ID ON MKT_PLANORDER(TENANT_ID);
CREATE INDEX IX_MPNR_TIME_STAMP ON MKT_PLANORDER(TENANT_ID,TIME_STAMP);
CREATE INDEX IX_MPNR_SHOP_ID ON MKT_PLANORDER(TENANT_ID,SHOP_ID);
CREATE INDEX IX_MPNR_PLAN_DATE ON MKT_PLANORDER(PLAN_DATE);
...
CREATE INDEX IX_MPND_TENANT_ID ON MKT_PLANDATA(TENANT_ID);
CREATE INDEX IX_MPND_PLAN_ID ON MKT_PLANDATA(TENANT_ID,PLAN_ID);
CREATE INDEX IX_MPND_SHOP_ID ON MKT_PLANDATA(TENANT_ID,SHOP_ID);
CREATE INDEX IX_MPND_GODS_ID ON MKT_PLANDATA(TENANT_ID,KPI_ID);
...
CREATE INDEX IX_MKR_TENANT_ID ON MKT_KPI_RESULT(TENANT_ID);
CREATE INDEX IX_MKR_TIME_STAMP ON MKT_KPI_RESULT(TENANT_ID,TIME_STAMP);
CREATE INDEX IX_MKR_KPI_YEAR ON MKT_KPI_RESULT(TENANT_ID,KPI_YEAR);
CREATE INDEX IX_MKR_KPI_ID ON MKT_KPI_RESULT(TENANT_ID,KPI_ID);
CREATE INDEX IX_MKR_PLAN_ID ON MKT_KPI_RESULT(TENANT_ID,PLAN_ID);
CREATE INDEX IX_MKR_SHOP_ID ON MKT_KPI_RESULT(TENANT_ID,SHOP_ID);
...
--数据源(考核分析)
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('5','考核分析表','REPORT_SOURCE','00',5497000);
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('6','费用分析表','REPORT_SOURCE','00',5497000);
 
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('DEPT_ID','部门','INDEX_TYPE5','00',5497000);
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('GUIDE_USER','人员','INDEX_TYPE5','00',5497000);
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('CLIENT_ID','客户','INDEX_TYPE5','00',5497000);
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('KPI_ID','考核指标','INDEX_TYPE5','00',5497000);
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('SHOP_ID','门店','INDEX_TYPE5','00',5497000);
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('CREGION_ID','客户所在区(县)','INDEX_TYPE5','00',5497000);
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('CREGION_ID1','客户所在省','INDEX_TYPE5','00',5497000);
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('CREGION_ID2','客户所在市','INDEX_TYPE5','00',5497000);
 
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('DEPT_ID','部门','INDEX_TYPE6','00',5497000);
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('CLIENT_ID','客户','INDEX_TYPE6','00',5497000);
 insert into PUB_PARAMS(CODE_ID,CODE_NAME,TYPE_CODE,COMM,TIME_STAMP) values('SHOP_ID','门店','INDEX_TYPE6','00',5497000);
