...
uses
  ...
  ufrmR3Main in 'ufrmR3Main.pas' {frmR3Main},
  ufrmR3Desk in 'ufrmR3Desk.pas' {frmR3Desk},
...
begin
  ...
  Application.CreateForm(TfrmR3Main, frmR3Main);
  Application.CreateForm(TfrmR3Desk, frmR3Desk);
