...
procedure TfrmR3Main.FormDestroy(Sender: TObject);
var
  i:integer;
begin
...
procedure TfrmR3Main.AddFrom(form: TForm);
var
  button:TrzBmpButton;
begin
...
procedure TfrmR3Main.RemoveFrom(form: TForm);
var
  i:integer;
begin
  for i:=0 to FList.Count -1 do
...
procedure TfrmR3Main.DoActiveForm(Sender: TObject);
begin
...
function TfrmR3Main.SortToolButton:boolean;
var
  i,w,wl:Integer;
...
procedure TfrmR3Main.DoActiveChange(Sender: TObject);
var
  i:integer;
  SOn:TNotifyEvent;
begin
...
procedure TfrmR3Main.DoFreeForm(Sender: TObject);
...
function TfrmR3Main.CheckVersion:boolean;
...
function TfrmR3Main.Login(Locked:boolean=false;Exited:boolean=true):boolean;
var
  ...
  if Logined then
     ...
     begin
       ...
       if Global.TENANT_ID = 0 then
          begin
            PostMessage(frmR3Main.Handle,WM_LOGIN_REQUEST,1,1);
            Exit;
          end
       else
          begin
...
procedure TfrmR3Main.wm_Login(var Message: TMessage);
var prm:string;
begin
  ...
  try
    ...
    Logined := Login(false);
    if not frmR3Main.Visible and Logined and not IsXsm then
    begin
      Application.Minimize;
      frmR3Main.Show;
      frmR3Main.WindowState := wsMaximized;
      Application.Restore;
    end;
  except
    on E:Exception do
...
procedure TfrmR3Main.SetLogined(const Value: boolean);
var s:string;
begin
  FLogined := Value;
...
procedure TfrmR3Main.miCloseClick(Sender: TObject);
begin
  inherited;
  Close;
end;

procedure TfrmR3Main.FormShow(Sender: TObject);
begin
  inherited;
  UpdateTimer.Enabled := true;
end;

procedure TfrmR3Main.CheckEnabled;
var
  i:integer;
  rs:TZQuery;
begin
...
procedure TfrmR3Main.FormCloseQuery(Sender: TObject;
...
procedure TfrmR3Main.N68Click(Sender: TObject);
begin
  inherited;
  if Logined then
  begin
...
procedure TfrmR3Main.wm_desktop(var Message: TMessage);
var
  i:integer;
  Form:TfrmBasic;
begin
  if not Logined then Exit;
//     begin
//       PostMessage(frmR3Main.Handle,WM_LOGIN_REQUEST,0,0);
//       Exit;
//     end;
...
procedure TfrmR3Main.WMQUERYENDSESSION(var msg: Tmessage);
begin
  SystemShutdown := true;
...
function TfrmR3Main.UpdateDbVersion: boolean;
var
...
procedure TfrmR3Main.Timer1Timer(Sender: TObject);
var
  P:PMsgInfo;
begin
  inherited;
...
procedure TfrmR3Main.LoadFrame;
var
  F:TIniFile;
begin
  inherited;
...
procedure TfrmR3Main.SetLoging(const Value: boolean);
begin
  FLoging := Value;
end;

procedure TfrmR3Main.SetSystemShutdown(const Value: boolean);
begin
  FSystemShutdown := Value;
end;

procedure TfrmR3Main.InitVersioin;
begin

end;

procedure TfrmR3Main.N90Click(Sender: TObject);
var
  HWndCalculator : HWnd;
begin
  // 查找已存在的计算器窗口
...
procedure TfrmR3Main.RzBmpButton10Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmR3Main.LoadMenu(subname:string='');
...
procedure TfrmR3Main.RzBmpButton9Click(Sender: TObject);
var i:integer;
begin
  inherited;
...
procedure TfrmR3Main.DoConnectError(Sender: TObject);
begin

end;

function TfrmR3Main.GetDeskFlag: string;
begin

end;

procedure TfrmR3Main.InitTenant;
var
  Params:TftParamList;
begin
...
function TfrmR3Main.ConnectToDb:boolean;
var
...
procedure TfrmR3Main.actfrmMeaUnitsExecute(Sender: TObject);
begin
  inherited;
  if not Logined then
     begin
...
procedure TfrmR3Main.actfrmDutyInfoListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmRoleInfoListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmDeptInfoListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmUsersExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmBrandInfoExecute(Sender: TObject);
begin
  inherited;
  if not Logined then
     begin
...
procedure TfrmR3Main.actfrmStockOrderListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmSalesOrderListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmChangeOrderList1Execute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmChangeOrderList2Execute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmGoodsInfoListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmGoodsSortExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmCodeInfo3Execute(Sender: TObject);
begin
  inherited;
  if not Logined then
     begin
...
procedure TfrmR3Main.actfrmSortInfoExecute(Sender: TObject);
begin
  inherited;
  if not Logined then
     begin
...
procedure TfrmR3Main.actfrmImplInfoExecute(Sender: TObject);
begin
  inherited;
  if not Logined then
     begin
...
procedure TfrmR3Main.actfrmAreaInfoExecute(Sender: TObject);
begin
  inherited;
  if not Logined then
     begin
...
procedure TfrmR3Main.actfrmSaleStyleExecute(Sender: TObject);
begin
  inherited;
  if not Logined then
     begin
...
procedure TfrmR3Main.actfrmSettleCodeExecute(Sender: TObject);
begin
  inherited;
  if not Logined then
     begin
...
procedure TfrmR3Main.actfrmShopGroupExecute(Sender: TObject);
begin
  inherited;
  if not Logined then
     begin
...
procedure TfrmR3Main.actfrmRecvOrderListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmPayOrderListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmClientExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmSupplierExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmSalRetuOrderListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmStkRetuOrderListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmPosMainExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmPriceGradeInfoExecute(Sender: TObject);
begin
  inherited;
  if not Logined then
     begin
...
procedure TfrmR3Main.actfrmSalIndentOrderListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmStkIndentOrderListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmInvoiceExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmCustomerExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmCostCalcExecute(Sender: TObject);
begin
  inherited;
{  if not Logined then
     begin
...
procedure TfrmR3Main.actfrmSysDefineExecute(Sender: TObject);
begin
  inherited;
  if not Logined then
     begin
...
procedure TfrmR3Main.actfrmDaysCloseExecute(Sender: TObject);
begin
  inherited;
  if not Logined then
     begin
...
procedure TfrmR3Main.actfrmMonthCloseExecute(Sender: TObject);
begin
  inherited;
  if not Logined then
     begin
...
procedure TfrmR3Main.actfrmCloseForDayExecute(Sender: TObject);
begin
  inherited;
  if not Logined then
     begin
...
procedure TfrmR3Main.actfrmPriceOrderListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmCheckOrderListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmDbOrderListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmShopInfoListExecute(Sender: TObject);
var
  Form:TfrmBasic;
  AObj:TRecord_;
begin
...
procedure TfrmR3Main.actfrmXsmBrowserExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmAccountExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmTransOrderListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmDevFactoryExecute(Sender: TObject);
begin
  inherited;
...
procedure TfrmR3Main.actfrmIoroOrderList1Execute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmIoroOrderList2Execute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmCheckTablePrintExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmRckMngExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmJxcTotalReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmStockDayReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmSaleDayReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmChange1DayReportExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmChange2DayReportExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmR3Main.actfrmLockScreenExecute(Sender: TObject);
begin
  inherited;
  frmR3Desk.HookLocked := true;
  try
    Login(true);
  finally
    frmR3Desk.HookLocked := false;
  end;

end;

procedure TfrmR3Main.actfrmStorageDayReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmRckDayReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmRelationExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmRecvDayReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmPayDayReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmRecvAbleReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmPayAbleReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmStorageTrackingExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmDbDayReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmGodsRunningReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.RzBmpButton13Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmR3Main.tlbCloseClick(Sender: TObject);
var
  i:integer;
begin
  for i:=0 to FList.Count -1 do
...
procedure TfrmR3Main.N103Click(Sender: TObject);
begin
  inherited;
  self.Cascade;
end;

procedure TfrmR3Main.actfrmIoroDayReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmMessageExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmNewPaperReaderExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.WriteAction(s: string;flag:integer);
var
  F:TIniFile;
begin
...
procedure TfrmR3Main.actfrmQuestionnaireExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.RzBmpButton11Click(Sender: TObject);
begin
  inherited;
  TfrmPswModify.ShowExecute(Global.UserId,Global.UserName);
...
procedure TfrmR3Main.RzBmpButton12Click(Sender: TObject);
begin
  inherited;
  Close;
...
procedure TfrmR3Main.RzBmpButton14Click(Sender: TObject);
begin
  inherited;
  actfrmQuestionnaire.OnExecute(actfrmQuestionnaire);
end;

procedure TfrmR3Main.RzBmpButton15Click(Sender: TObject);
begin
  inherited;
  actfrmMessage.OnExecute(actfrmMessage);
end;

procedure TfrmR3Main.actfrmInLocusOrderListExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmOutLocusOrderListExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.lblUserInfoClick(Sender: TObject);
begin
  inherited;
  actfrmNewPaperReader.OnExecute(nil);
end;

procedure TfrmR3Main.actfrmDownIndeOrderExecute(Sender: TObject);
var
  vData: OleVariant;
  Aobj: TRecord_;
  Form: TfrmBasic;
...
procedure TfrmR3Main.actfrmRecvForDayExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.rzUserInfoClick(Sender: TObject);
begin
  inherited;
  actfrmNewPaperReader.OnExecute(nil);
end;

procedure TfrmR3Main.actfrmImpeachExecute(Sender: TObject);
begin
  inherited;
  TfrmImpeach.ShowImpeach(self); 
end;

procedure TfrmR3Main.actfrmClearDataExecute(Sender: TObject);
begin
  inherited;
...
function TfrmR3Main.ConnectToRsp: boolean;
var
  rs:TZQuery;
  rspComVersion:string;
begin
...
procedure TfrmR3Main.actfrmSaleAnalyExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.wm_message(var Message: TMessage);
begin
...
procedure TfrmR3Main.actfrmSaleManSaleReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmClientSaleReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.DoLoadMsg(Sender: TObject);
begin
  if not Visible then Exit;
...
procedure TfrmR3Main.actfrmSaleTotalReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmStgTotalReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.actfrmStockTotalReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
function TfrmR3Main.ConnectToXsm: boolean;
const
...
procedure TfrmR3Main.RzTrayIcon1LButtonDblClick(Sender: TObject);
begin
  inherited;
  if Logined then
  begin
...
procedure TfrmR3Main.actfrmSaleMonthTotalReportExecute(Sender: TObject);
var
  Form:TfrmBasic;
begin
  inherited;
...
procedure TfrmR3Main.rzSizeLeft_1Resize(Sender: TObject);
begin
  inherited;
  frmMain.OnResize(nil);
end;

procedure TfrmR3Main.LoadPic32;
var
  DllHandle: THandle;
...
procedure TfrmR3Main.actfrmXsmNetExecute(Sender: TObject);
var
  s:string;
  Form:TfrmBasic;
  sl:TStringList;
...
procedure TfrmR3Main.splitClick(Sender: TObject);
begin
  inherited;
  Exit;
...
procedure TfrmR3Main.page_03Click(Sender: TObject);
begin
  inherited;
  LoadMenu('网上配货');
...
procedure TfrmR3Main.page_04Click(Sender: TObject);
begin
  inherited;
  LoadMenu('网上结算');
...
procedure TfrmR3Main.page_02Click(Sender: TObject);
begin
  inherited;
  LoadMenu('网上订货');
...
procedure TfrmR3Main.page_12Click(Sender: TObject);
begin
  inherited;
  LoadMenu('品牌培育');
...
procedure TfrmR3Main.page_13Click(Sender: TObject);
begin
  inherited;
  LoadMenu('信息互通');
...
procedure TfrmR3Main.page_14Click(Sender: TObject);
begin
  inherited;
  LoadMenu('广告宣传');
...
procedure TfrmR3Main.tbDesktopClick(Sender: TObject);
begin
  inherited;
  actfrmOpenDeskExecute(nil);
end;

procedure TfrmR3Main.page_11Click(Sender: TObject);
begin
  inherited;
  Clear;
  tbDesktopClick(nil);
...
procedure TfrmR3Main.AddModule(mid: string;Action:TAction);
var
  button:TrzBmpButton;
begin
  button := TrzBmpButton.Create(rzToolButton);
...
procedure TfrmR3Main.page_01Click(Sender: TObject);
begin
  inherited;
  LoadMenu('网上营销');
...
procedure TfrmR3Main.actfrmRimNetExecute(Sender: TObject);
var
  s:string;
  Form:TfrmBasic;
  sl:TStringList;
...
procedure TfrmR3Main.FormResize(Sender: TObject);
var
  bh:integer;
  br:integer;
begin
...
procedure TfrmR3Main.actfrmCalcStorageExecute(Sender: TObject);
begin
  inherited;
...
procedure TfrmR3Main.actfrmStorageOptionDefineExecute(Sender: TObject);
begin
  inherited;
...
procedure TfrmR3Main.actfrmOpenDeskExecute(Sender: TObject);
begin
  inherited;
  ...
  frmR3Desk.Locked := true;
  frmR3Desk.BringToFront;
//  rzLeft.Width := 171;
//  lblUserInfo.Visible := (rzLeft.Width <> 35);
//  frmMain.OnResize(frmMain);
  UnSelect;
...
procedure TfrmR3Main.actfrmSyncAllExecute(Sender: TObject);
begin
  inherited;
  if CaFactory.Audited then
     begin
...
procedure TfrmR3Main.RzBmpButton2Click(Sender: TObject);
begin
  inherited;
  Close;
...
procedure TfrmR3Main.RzBmpButton1Click(Sender: TObject);
var i:integer;
begin
  inherited;
...
procedure TfrmR3Main.RzBmpButton3Click(Sender: TObject);
begin
  inherited;
  actfrmSyncAll.OnExecute(actfrmSyncAll);
end;

procedure TfrmR3Main.Image9Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmR3Main.wm_check(var Message: TMessage);
begin
...
procedure TfrmR3Main.RzTrayIcon1MinimizeApp(Sender: TObject);
var Form:TForm;
begin
  inherited;
  Form := FindChildForm(TfrmPosMain);
...
procedure TfrmR3Main.RzTrayIcon1RestoreApp(Sender: TObject);
var Form:TForm;
begin
  inherited;
  Form := FindChildForm(TfrmPosMain);
