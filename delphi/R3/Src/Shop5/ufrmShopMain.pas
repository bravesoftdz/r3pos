...
procedure TfrmShopMain.actfrmMktGodsReportExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmShopMain.actfrmPlanOrderList3Execute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if not Logined then
...
procedure TfrmShopMain.actfrmStkInvoiceListExecute(Sender: TObject);
var Form:TfrmBasic;
begin
  inherited;
  if ShopGlobal.offline then Raise Exception.Create('此功能不能脱机操作。。。');
