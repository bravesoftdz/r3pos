inherited frmStockReport: TfrmStockReport
  Left = 200
  Top = 213
  Caption = #36827#36135#32479#35745#25253#34920
  ClientWidth = 991
  OnCreate = FormCreate
  ...
  object dsReport1: TDataSource [3]
    DataSet = cdsReport1
    Left = 254
    Top = 275
  end
  object cdsReport2: TZQuery [4]
    FieldDefs = <>
  ...
  object dsReport2: TDataSource [5]
    DataSet = cdsReport2
    Left = 254
    Top = 315
  end
