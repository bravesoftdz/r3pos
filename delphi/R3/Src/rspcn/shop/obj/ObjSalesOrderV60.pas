...
begin
  ...
  SelectSQL.Text :=
               ...
               'j.HAS_INTEGRAL,j.REMARK,j.TREND_ID,b.BARCODE from SAL_SALESDATA j inner join ('+Params.ParambyName('VIW_GOODSINFO').AsString+') b on j.TENANT_ID=b.TENANT_ID and j.GODS_ID=b.GODS_ID where j.TENANT_ID=:TENANT_ID and j.SALES_ID=:SALES_ID order by SEQNO';
  IsSQLUpdate := True;
