...
begin
  ...
  try
    ...
    begin
      ...
      'values(:TENANT_ID,''#'',''普通客户'',''PT'',0,0,0,0,0,0,1,''00'',5497000)';
      AGlobal.ExecSQL(Str,Params);
      Str := 'insert into PUB_PRICEGRADE(TENANT_ID,PRICE_ID,PRICE_NAME,PRICE_SPELL,INTEGRAL,INTE_TYPE,INTE_AMOUNT,MINIMUM_PERCENT,AGIO_TYPE,AGIO_PERCENT,SEQ_NO,COMM,TIME_STAMP)'+
      'values(:TENANT_ID,''332E5CE8-D1FC-4D53-84C3-2A1EB07EF8AA'',''银卡会员'',''YK'',0,0,0,0,0,0,1,''00'',5497000)';
      AGlobal.ExecSQL(Str,Params);
      Str := 'insert into PUB_PRICEGRADE(TENANT_ID,PRICE_ID,PRICE_NAME,PRICE_SPELL,INTEGRAL,INTE_TYPE,INTE_AMOUNT,MINIMUM_PERCENT,AGIO_TYPE,AGIO_PERCENT,SEQ_NO,COMM,TIME_STAMP)'+
      'values(:TENANT_ID,''26AB5597-5AA5-49BC-8CBF-7A332CB1B6FA'',''金卡会员'',''JK'',0,0,0,0,0,0,1,''00'',5497000)';
      AGlobal.ExecSQL(Str,Params);
      Str := 'insert into PUB_PRICEGRADE(TENANT_ID,PRICE_ID,PRICE_NAME,PRICE_SPELL,INTEGRAL,INTE_TYPE,INTE_AMOUNT,MINIMUM_PERCENT,AGIO_TYPE,AGIO_PERCENT,SEQ_NO,COMM,TIME_STAMP)'+
      'values(:TENANT_ID,''4433497A-0A2E-4D72-BE0B-723850A6EFE8'',''钻石会员'',''ZS'',0,0,0,0,0,0,1,''00'',5497000)';
      AGlobal.ExecSQL(Str,Params);
    end;
    result := true;
    AGlobal.CommitTrans;
